...
-- Insert Users
INSERT INTO users (id, username, email, password, is_enabled, account_no_expired, account_no_locked, credential_no_expired) VALUES
(1, 'Alexis', 'alexis@example.com', '$2a$10$3S84.aE5GAxLMeXyDUFkruNnoQVE/UOM6iY35vtwirheoBfl7B9qC', true, true, true, true),
(2, 'Jose', 'jose@example.com', '$2a$10$3S84.aE5GAxLMeXyDUFkruNnoQVE/UOM6iY35vtwirheoBfl7B9qC', true, true, true, true),
(3, 'Pepe', 'pepe@example.com', '$2a$10$3S84.aE5GAxLMeXyDUFkruNnoQVE/UOM6iY35vtwirheoBfl7B9qC', true, true, true, true),
(4, 'Israel', 'israel@example.com', '$2a$10$3S84.aE5GAxLMeXyDUFkruNnoQVE/UOM6iY35vtwirheoBfl7B9qC', true, true, true, true);
